...
class AX25Framer(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "AX_framer", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("AX_framer")
        ...
        self.settings = Qt.QSettings("GNU Radio", "AX25Framer")
        ...
        self.analog_random_source_x_0 = blocks.vector_source_i(list(map(int, numpy.random.randint(0, 2, 100))), True)
...
def main(top_block_cls=AX25Framer, options=None):
